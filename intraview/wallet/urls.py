...
urlpatterns = [
    ...
    path('payouts/request/',views_interviewer.InterviewerPayoutRequestCreateAPIView.as_view(),name='payout-request-create'),
    
    # Payout list and detail
    path('payouts/',views_interviewer.InterviewerPayoutListAPIView.as_view(),name='payout-list'),
    path('payouts/<int:payout_id>/',views_interviewer.InterviewerPayoutDetailAPIView.as_view(),name='payout-detail'),
    
    # Utility endpoints
    path('payouts/stats/',views_interviewer.InterviewerPayoutStatsAPIView.as_view(),name='payout-stats'),
    path('payouts/eligibility/',views_interviewer.InterviewerPayoutEligibilityCheckAPIView.as_view(),name='payout-eligibility'),
