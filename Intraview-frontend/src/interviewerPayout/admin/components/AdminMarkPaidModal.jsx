...
/**
 * AdminMarkPaidModal Component
 * Modal for marking approved payout as paid
 */
const AdminMarkPaidModal = ({ isOpen, onClose, onConfirm, payout, loading }) => {
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 p-4 mb-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-blue-800 dark:text-blue-200">
                <p className="font-medium mb-1">Confirm payment processed:</p>
                ...
                <p>Account: <strong>{payout?.bank_account_number}</strong></p>
                <p className="mt-2 text-xs">
                  Ensure the payment has been successfully transferred before confirming.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              rows={3}
              placeholder="Transaction ID, payment method, or other details..."
...
export default AdminMarkPaidModal;
