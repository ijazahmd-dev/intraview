    ...
    <div>
      ...
      <div className="space-y-5 text-sm text-slate-700">
        ...
        <section className="border border-slate-100 rounded-xl p-4">
          ...
          <p>
            <span className="font-medium">Specializations:</span>{" "}
            {data.specializations?.length ? data.specializations.join(", ") : "-"}
          </p>
          <p>
            <span className="font-medium">Languages:</span>{" "}
            {data.languages?.length ? data.languages.join(", ") : "-"}
        ...
        <section className="border border-amber-100 bg-amber-50 rounded-xl p-4 text-xs text-amber-900">
          ...
          <p>
            By submitting this application, you confirm that all information
            provided is accurate and complete. You agree to Intraview's terms,
            confidentiality expectations, and interviewer code of conduct.
          </p>
        </section>
